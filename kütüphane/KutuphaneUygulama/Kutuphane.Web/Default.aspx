<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Kutuphane.Web.Default" %>
			  ...
			  <header id="header" id="home">
			    <div class="container">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="index.html"><img src="/temp/img/logo.png" alt="" title="" /></a>
				      </div>
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          <li class="menu-active"><a href="#home"></a></li>
				          <li><a href="#about"></a></li>
				          <li><a href="#fact"></a>Ana Sayfa</li>
				          <li><a href="#price">Hakkında</a></li>
				          <li><a href="#course"></a>Üye Giriş</li>
				          <li class="menu-has-children"><a href="">Seçenekler</a>
				            <ul>
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-7">
							<h5 class="text-white text-uppercase"><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></h5>
							<h1 class="text-uppercase">
								<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>				
							</h1>
							<p class="text-white pt-20 pb-20">
                                Bu Bir Sanal Kütüphanedir.
							</p>
							<a href="#" class="primary-btn text-uppercase">tıklayın</a>
						</div>
						<div class="col-lg-5 banner-right">
							<img class="img-fluid" src="/temp/img/header-img.png" alt="">
						</div>												
					</div>
				</div>
			</section>
					...
					<div class="single-info row mt-40 align-items-center">
						<div class="col-lg-6 col-md-12 text-center no-padding info-left">
							<div class="info-thumb">
								<img src="/temp/img/about-img.jpg" class="img-fluid info-img" alt="">
							</div>
						</div>
						<div class="col-lg-6 col-md-12 no-padding info-rigth">
							<div class="info-content">
								...
								<br>
								<img src="/temp/img/signature.png" alt="">
								</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="active-course-carusel">
							<div class="single-course item">
								<img class="img-fluid" src="/temp/img/c1.jpg" alt="">
							...
							<div class="single-course item">
								<img class="img-fluid" src="/temp/img/c2.jpg" alt="">
								<p class="sale-btn">For Sale</p>
								<div class="details">
									<a href="#"><h4>Breakthrough Thinking <span class="price float-right">$25</span></h4></a>	
									<p>
							...
							<div class="single-course item">
								<img class="img-fluid" src="/temp/img/c3.jpg" alt="">
								<p class="sale-btn">For Sale</p>
								<div class="details">
									<a href="#"><h4>Breakthrough Thinking <span class="price float-right">$25</span></h4></a>	
									<p>
					...
					<div class="row">
						<div class="active-tstimonial-carusel">
							<div class="single-testimonial item">
								<img class="mx-auto" src="/temp/img/t1.png" alt="">
								<p class="desc">
							...
							<div class="single-testimonial item">
								<img class="mx-auto" src="/temp/img/t2.png" alt="">
								<p class="desc">
									Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware and more. laptop accessory
								</p>
								<h4>Mark Alviro Wiens</h4>
							...
							<div class="single-testimonial item">
								<img class="mx-auto" src="/temp/img/t3.png" alt="">
								<p class="desc">
									Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware and more. laptop accessory
								</p>
								<h4>Mark Alviro Wiens</h4>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
			...
			<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
  			<script src="/temp/js/easing.min.js"></script>			
			<script src="/temp/js/hoverIntent.js"></script>
			...
			<script src="/temp/js/mail-script.js"></script>	
